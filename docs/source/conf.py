...
latex_documents = [
    (master_doc, "mdaf3.tex", "mdaf3 Documentation",
     "mdaf3", "manual"),
]
...
man_pages = [
    (master_doc, "mdaf3", "mdaf3 Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "mdaf3", "mdaf3 Documentation",
     author, "mdaf3", "Easy analysis of protein structure predictions with MDAnalysis",
     "Miscellaneous"),
]
